...
N -520 120 -440 120 {lab=Vin_shifted}
N -580 120 -580 150 {lab=#net4}
N -690 -110 -660 -110 {lab=Vout}
N -670 150 -640 150 {lab=Vout}
...
C {lab_pin.sym} -670 150 2 1 {name=p37 lab=Vout}
...
C {sg13cmos5l_pr/rhigh.sym} -610 150 1 0 {name=R2
w=0.5e-6
l="1e-6*2"
model=rhigh
body=sub!
...
C {sg13cmos5l_pr/moscap_p.sym} -600 -80 3 0 {name=C1
l=5.0u
w=5.0u
m=3
mm_ok=1
...
C {sg13cmos5l_pr/moscap_p.sym} -580 120 3 0 {name=C2
l=5.0u
w=5.0u
m=3
mm_ok=1
